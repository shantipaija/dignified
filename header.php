...
<body <?php body_class(); ?> itemscope itemtype="https://schema.org/WebPage">
				...
				<div class="container">
					<div class="row">
						...
						<div class="site-navigation-inner col-md-12">
							...
							<?php dignified_header_menu(); // main navigation ?>
	...
	<div id="content" class="site-content">
		<div class="top-section">
			<?php dignified_featured_slider(); ?>
			<?php dignified_call_for_action(); ?>
		</div>
		<div class="container main-content-area">
			...
			?>
				<div class="main-content-inner <?php echo dignified_main_content_bootstrap_classes(); ?>">
