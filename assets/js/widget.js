jQuery( document ).ready(function() {
    var mediaControl = {
        ...
        select: function() {
            ...
            var selector = jQuery( '.dignified-media-container' ).find( mediaControl.selector );
            var data = {
                action: 'dignified_get_attachment_media',
                attachment_id: id
            };
            ...
            jQuery.post( dignified.ajaxurl, data, function( response ) {
        ...
        init: function() {
            ...
            context.on( 'click', '.dignified-media-container .upload-button', function( e ) {
                var container = jQuery( this ).parents( '.dignified-media-container' ),
            ...
            context.on( 'click', '.dignified-media-container .remove-button', function( e ) {
                var container = jQuery( this ).parents( '.dignified-media-container' ),
                    sibling = container.find( 'input' ),
