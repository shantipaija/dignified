...
function generateMobileMenu() {
    ...
    if ( dignifiedIsMobile() && jQuery( window ).width() > 767 ) {
        menu.addClass( 'dignified-mobile-menu' );
    } else {
        menu.removeClass( 'dignified-mobile-menu' );
    }
}
...
jQuery( document ).ready(function() {
    ...
    jQuery( '.dignified-dropdown' ).click( function( evt ) {
